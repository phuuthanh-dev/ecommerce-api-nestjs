...
const logoURL = 'https://avatars.githubusercontent.com/u/102614541?v=4'
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>Nếu bạn không thực hiện yêu cầu này, hãy bỏ qua email này.</Text>
      </Container>
      <Text style={footer}>From phuuthanh with ❤</Text>
    </Body>
  </Html>
)
